        ...
        <div className='grid grid-cols-2 gap-10 lg:grid-cols-12 lg:gap-16'>
          ...
          <div className='col-span-2 lg:col-span-6'>
            <div className='bg-primary/20 rounded-xl'>
              <div className='p-10'>
                <h6 className='mb-4 text-xl text-white'></h6>
                ...
                <form onSubmit={handleSubmit} className='mb-6 space-y-2'>
                  ...
                  <div className='relative'>
                    <input type="email" id='email'
                      name='email' className='bg-default-950/60 pe-40 ps-4 h-12 w-full rounded-lg border-white/10 py-4 text-white
                    ...
                    border-primary bg-primary end-[6px] absolute top-[6px] inline-flex h-9 items-center justify-center gap-2 rounded-md
                ...
                <div>
                  ...
                  <ul className='flex flex-wrap items-center gap-1'>
                    {[<TiSocialFacebook />, <TiSocialLinkedin />, <TiSocialTwitter />, <TiSocialYoutube />].map((social, index) => (
                      <li key={index}>
                        <a href="#" className='hover:bg-primary group inline-flex h-10 w-10 items-center justify-center rounded-lg border
