        ...
        <div className="mb-10 flex items-end justify-between">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className='text-default-200 text-sm font-medium'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione nihil laborum reiciendis, 
              amet nam mollitia molestias earum molestiae in provident quo dolore voluptas fuga veritatis 
              eos est, quod aliquam. Veritatis.
            </p>
          </div>
        </div>
            ...
            <div className='bg-default-950/40 hover:-translate-y-2 border-primary border-s-2 rounded-xl backdrop-blur-3xl transition-all duration-500'>
              <div className='p-10'>
                ...
                <p className='text-default-100 mb-4 text-sm font-medium'>
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eos doloribus quasi 
                  maiores voluptate perferendis, nemo excepturi! Enim expedita, neque, 
                </p>
