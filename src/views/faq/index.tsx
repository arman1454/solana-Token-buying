        ...
        <div className="mb-10 flex items-end justify-between">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className='text-default-200 text-sm font-medium'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident quasi explicabo laudantium
              reprehenderit voluptates, at eius consequatur tenetur delectus? Eius, ab doloribus officiis
            </p>
          </div>
        </div>
